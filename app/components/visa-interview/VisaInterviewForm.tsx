  ...
  return (
    <div className="max-w-4xl mx-auto">
      <p className="text-lg text-gray-600 text-center mb-12">
        Préparez-vous à votre entretien de visa avec notre simulateur interactif. Répondez aux questions de l'agent consulaire et recevez des retours personnalisés.
      </p>
      ...
      <div className="bg-white rounded-xl shadow-lg p-6 mb-8">
        <div className="flex items-center space-x-4 mb-6">
          ...
          <div>
            <h2 className="text-lg font-semibold text-gray-900">Question {currentQuestion + 1}/{questions.length}</h2>
            <p className="text-gray-600">Agent Consulaire - Ambassade de France</p>
          </div>
        </div>

        <div className="bg-gray-50 rounded-xl p-6 mb-6 min-h-[300px] overflow-y-auto">
          {messages.length === 0 ? (
            <div className="text-center text-gray-500">
              <MessageSquare className="w-8 h-8 mx-auto mb-4 text-violet-300" />
